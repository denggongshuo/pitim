package com.pit.im.redis.aspect;


import com.pit.im.redis.annotation.RedisCache;
import com.pit.im.redis.annotation.RedisEvict;
import com.pit.im.redis.utils.RedisUtils;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.pit.im.redis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(com.pit.im.redis.annotation.RedisEvict)")
