 ...
 ***************************************************************************************
 */
package com.pit.im.server.model;
...
public class Session implements Serializable{
	...
	private static final long serialVersionUID = -7590629745311706707L;
	...
	public  boolean write(Object msg) {
		...
		if(session!=null&&isConnected())
		{
			...
			try{
				...
				script.appendCall(ImConstants.DWRConfig.DWR_SCRIPT_FUNCTIONNAME, json);
				dwrsession.addScript(script); */
				return  true; 
			}catch(Exception e){
